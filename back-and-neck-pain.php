...
<head>
    ...
    <title>Back & Neck Pain / Slipped Disc – Nano Hospitals</title>
    <style>
        .pill-btn {
            padding: 8px 18px;
...
<section class="relative w-full min-h-[520px]">
    <img src="./assets/banners/health-package-banner.png" alt="Back and Neck Pain"
        ...
        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            ...
            <div class="flex-1 md:pl-10">
                <p class="text-gray-500 text-sm md:text-base leading-relaxed">
                    Back and neck pain are common musculoskeletal problems often caused by a
                    slipped disc, a condition in which the soft inner material of a spinal disc
                    bulges or herniates and presses on nearby nerves.
                </p>

                <div id="moreContent"
                    class="hidden mt-2 text-gray-500 text-sm md:text-base leading-relaxed">
                    <p>
                        This nerve compression can result in pain, numbness, tingling, and weakness
                        in the arms or legs, depending on the affected area of the spine.
                    </p>
                    <p class="mt-2">
                        At Nano Hospitals, spine care focuses on pain relief, nerve protection,
                        mobility restoration, and long-term spine health.
                    </p>
                </div>
...
<section id="overview" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        <h2 class="text-2xl md:text-3xl font-semibold mb-6">
            Introduction to Back & Neck Pain
        </h2>
        <p class="text-gray-700 leading-relaxed">
            A slipped disc occurs when spinal disc material protrudes and compresses nearby nerves.
            This can lead to significant back or neck pain and neurological symptoms if not treated
            promptly.
        </p>
    </div>
</section>
...
<section id="delivery" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Poor posture and prolonged sitting</li>
            <li>Heavy lifting or sudden strain</li>
            <li>Age-related disc degeneration</li>
            <li>Trauma or spinal injury</li>
        </ul>
    </div>
</section>
...
<section id="benefits" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Chronic and worsening pain</li>
            <li>Nerve damage</li>
            <li>Reduced mobility and disability</li>
            <li>Paralysis in rare severe cases</li>
        </ul>
    </div>
</section>
...
<section id="risks" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Clinical and neurological examination</li>
            <li>X-rays for spinal alignment</li>
            <li>MRI to assess disc herniation</li>
            <li>Maintaining good posture</li>
            <li>Regular exercise and ergonomic practices</li>
        </ul>
    </div>
</section>
...
<section id="advantages" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <li>Surgical procedures such as discectomy or laminectomy in severe cases</li>
        </ul>
    </div>
</section>
...
<section id="faqs" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <p class="text-gray-700 leading-relaxed">
            Most patients recover with conservative treatment, including medication and
            physiotherapy. Surgical intervention, when required, often provides significant pain
            relief and restores normal function.
        </p>
    </div>
</section>
