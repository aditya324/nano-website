...
<head>
    ...
    <title>Osteoarthritis – Nano Hospitals</title>
    <style>
        .pill-btn {
            padding: 8px 18px;
...
<section class="relative w-full min-h-[520px]">
    <img src="./assets/banners/health-package-banner.png" alt="Osteoarthritis"
        ...
        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            ...
            <div class="flex-1 md:pl-10">
                <p class="text-gray-500 text-sm md:text-base leading-relaxed">
                    Osteoarthritis is a degenerative joint disease characterised by the gradual
                    breakdown of cartilage, leading to joint pain, stiffness, and reduced mobility.
                ...
                <div id="moreContent"
                    ...
                    <p>
                        As cartilage wears away, bones may rub against each other, causing
                        inflammation, discomfort, and functional limitation.
                    </p>
                    <p class="mt-2">
                        At Nano Hospitals, osteoarthritis care focuses on pain control, movement
                        preservation, and improving long-term quality of life.
                    </p>
                </div>
...
<section id="overview" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <p class="text-gray-700 leading-relaxed">
            Osteoarthritis develops when joint cartilage gradually deteriorates over time,
            resulting in pain, stiffness, and limited movement. It is one of the most common
            causes of joint-related disability.
        </p>
    </div>
</section>
...
<section id="delivery" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <li>Obesity and increased joint stress</li>
...
<section id="risks" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <li>X-rays to assess joint damage</li>
            <li>MRI when detailed evaluation is required</li>
            <li>Weight control and regular low-impact exercise</li>
            <li>Avoidance of joint injuries</li>
        </ul>
    </div>
</section>
...
<section id="advantages" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Pain medications (NSAIDs)</li>
            <li>Physiotherapy and strengthening exercises</li>
            <li>Joint injections for pain relief</li>
            <li>Joint replacement surgery in advanced cases</li>
        </ul>
    </div>
</section>
...
<section id="faqs" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <p class="text-gray-700 leading-relaxed">
            While osteoarthritis cannot be reversed, appropriate treatment significantly reduces
            pain, improves joint function, and helps patients maintain an active and independent
            lifestyle.
        </p>
    </div>
</section>
