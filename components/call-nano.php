...
<!-- Desktop Floating Actions (ATTACHED) -->
<div class="fixed right-0 top-1/2  -translate-y-1/2 z-50 hidden md:flex flex-col">

  <button
    onclick="openContact('call')"
    class="w-12 h-12 rounded-l-2xl rounded-r-none
           bg-red-500 flex items-center justify-center shadow-lg">
    <img src="../assets/icons/call (2).png" class="w-5" />
  </button>

  <button
    onclick="openContact('whatsapp')"
    class="w-12 h-12 rounded-l-2xl rounded-r-none
           bg-green-500 flex items-center justify-center shadow-lg">
    <img src="../assets/icons/whatsapp (2).png" class="w-5" />
  </button>
...
<!-- Mobile Action Bar -->
<div
  class="fixed bottom-0 left-1/2 z-40 flex -translate-x-1/2 items-center gap-3
  ...
  function openContact(type) {
    ...
    if (type === 'whatsapp') {
      setItem(
        ...
        '../assets/icons/model-whatsapp.png',
        'Hulimavu WhatsApp',
        '+91 89295 00500',
