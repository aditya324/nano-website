...
<head>
    ...
    <title>Fractures & Injury / Trauma – Nano Hospitals</title>
    <style>
        .pill-btn {
            padding: 8px 18px;
...
<section class="relative w-full min-h-[520px]">
    <img src="./assets/banners/health-package-banner.png" alt="Fractures and Trauma"
    ...
    <div class="container mx-auto px-6">
        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            <h2 class="text-xl md:text-2xl font-bold text-[#5E5E5E] whitespace-nowrap">
                About Fractures & Trauma
            </h2>

            <div class="flex-1 md:pl-10">
                <p class="text-gray-500 text-sm md:text-base leading-relaxed">
                    Fractures are breaks or cracks in bones caused by trauma such as falls,
                    accidents, or sports injuries. They may also occur due to weakened bones
                    from conditions like osteoporosis.
                </p>

                <div id="moreContent"
                    class="hidden mt-2 text-gray-500 text-sm md:text-base leading-relaxed">
                    <p>
                        Injuries can range from simple fractures to complex trauma involving
                        joints, soft tissues, and nerves, requiring timely medical attention.
                    </p>
                    <p class="mt-2">
                        At Nano Hospitals, trauma care focuses on rapid diagnosis, proper
                        stabilization, and complete functional recovery.
                    </p>
                </div>
...
<section id="overview" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        <h2 class="text-2xl md:text-3xl font-semibold mb-6">
            Introduction to Fractures & Trauma
        </h2>
        <p class="text-gray-700 leading-relaxed">
            Fractures occur when excessive force is applied to a bone, causing it to break.
            Prompt diagnosis and proper treatment are essential to prevent long-term
...
<section id="workflow" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <li>Loss of movement or function</li>
        </ul>
    </div>
</section>
...
<section id="delivery" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Falls and slips</li>
            <li>Road traffic accidents</li>
            <li>Sports-related injuries</li>
            <li>Weak bones due to osteoporosis</li>
        </ul>
    </div>
</section>
...
<section id="benefits" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Poor bone healing or malunion</li>
...
<section id="risks" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>X-rays to confirm fractures</li>
            <li>CT or MRI for complex injuries</li>
            <li>Use of safety equipment such as helmets and seatbelts</li>
            <li>Fall prevention measures in elderly individuals</li>
            <li>Maintaining bone strength and overall fitness</li>
        </ul>
    </div>
</section>
...
<section id="advantages" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Casting or splinting to immobilize the bone</li>
            <li>Surgical fixation using plates, screws, or rods</li>
...
<section id="faqs" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <p class="text-gray-700 leading-relaxed">
            Most fractures heal within 6 to 12 weeks with proper treatment. Rehabilitation
            plays a key role in restoring strength, mobility, and normal daily activities.
        </p>
    </div>
</section>
