...
<head>
    ...
    <title>Diabetes – Nano Hospitals</title>
    <style>
        .pill-btn {
            padding: 8px 18px;
...
<body>
    ...
    <section class="relative w-full min-h-[520px]">
        <img src="./assets/banners/health-package-banner.png" alt="Diabetes"
            ...
            <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                ...
                <div class="flex-1 md:pl-10">
                    <p class="text-gray-500 text-sm md:text-base leading-relaxed">
                        Diabetes is a metabolic disorder characterised by persistently high blood sugar
                        levels due to insufficient insulin production or resistance to insulin action.
                    </p>

                    <div id="moreContent"
                        class="hidden mt-2 text-gray-500 text-sm md:text-base leading-relaxed">
                        <p>
                            Over time, uncontrolled diabetes can damage blood vessels, nerves, kidneys,
                            eyes, and the heart. Early diagnosis and structured management are essential to
                            prevent complications.
                        </p>
                        <p class="mt-2">
                            At Nano Hospitals, diabetes care focuses on long-term blood sugar control,
                            lifestyle modification, and complication prevention.
                        </p>
                    </div>
    ...
    <section id="overview" class="scroll-mt-32 bg-white py-14">
        <div class="container mx-auto px-4">
            ...
            <p class="text-gray-700 leading-relaxed">
                Diabetes occurs when the body cannot effectively regulate blood glucose levels due to
                insulin deficiency or resistance. It requires lifelong monitoring and management.
            </p>
        </div>
    </section>
    ...
    <section id="delivery" class="scroll-mt-32 bg-white py-14">
        <div class="container mx-auto px-4">
            ...
            <ul class="list-disc pl-5 space-y-2 text-gray-700">
                ...
                <li>Autoimmune destruction of insulin-producing cells (Type 1)</li>
            </ul>
        </div>
    </section>
    ...
    <section id="risks" class="scroll-mt-32 bg-white py-14">
        <div class="container mx-auto px-4">
            ...
            <ul class="list-disc pl-5 space-y-2 text-gray-700">
                ...
                <li>HbA1c test for long-term glucose control</li>
                <li>Healthy diet and regular physical activity</li>
                <li>Weight control and lifestyle modification</li>
            </ul>
        </div>
    </section>
    ...
    <section id="advantages" class="scroll-mt-32 bg-[#f6f6f6] py-14">
        <div class="container mx-auto px-4">
            ...
            <ul class="list-disc pl-5 space-y-2 text-gray-700">
                <li>Insulin therapy when required</li>
                <li>Oral medications such as metformin</li>
                <li>Dietary planning and lifestyle changes</li>
    ...
    <section id="faqs" class="scroll-mt-32 bg-white py-14">
        <div class="container mx-auto px-4">
            ...
            <p class="text-gray-700 leading-relaxed">
                Diabetes cannot be cured, but with proper treatment, lifestyle changes, and regular
                monitoring, it can be effectively controlled, allowing patients to live healthy,
                productive lives.
            </p>
        </div>
    </section>
