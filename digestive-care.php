...
<head>
    ...
    <title>Kidney Care – Nano Hospitals</title>
    <style>
        .pill-btn {
            padding: 8px 18px;
...
<section class="relative w-full min-h-[520px]">
    <img src="./assets/banners/health-package-banner.png" alt="Kidney Care"
        ...
        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            ...
            <div class="flex-1 md:pl-10">
                <p class="text-gray-500 text-sm md:text-base leading-relaxed">
                    Kidneys play a vital role in filtering waste, regulating blood pressure,
                    balancing fluids, and maintaining metabolic stability.
                    Kidney Care at Nano Hospitals focuses on early detection,
                    precise treatment, and long-term disease management.
                </p>

                <div id="moreContent"
                    class="hidden mt-2 text-gray-500 text-sm md:text-base leading-relaxed">
                    <p>
                        Kidney disorders often progress silently until advanced stages.
                        Early evaluation and continuous monitoring are essential
                        to prevent irreversible damage.
                    </p>
                    <p class="mt-2">
                        Care is delivered through expert nephrologists,
                        advanced dialysis services, and transplant coordination.
                    </p>
                </div>
...
<section id="overview" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        <h2 class="text-2xl md:text-3xl font-semibold mb-6">
            Introduction to Kidney Care
        </h2>
        <p class="text-gray-700 leading-relaxed">
            Kidney Care focuses on preventing, diagnosing, and managing disorders
            that affect kidney structure and function.
            Early identification helps slow disease progression and reduce complications.
        </p>
    </div>
</section>
...
<section id="workflow" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <li>Hypertension-related kidney damage</li>
...
<section id="delivery" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700 mb-4">
            <li>Swelling of legs, ankles, and face</li>
            <li>Fatigue and weakness</li>
            <li>Changes in urine output or foamy urine</li>
            <li>Blood in urine</li>
            <li>Persistent high blood pressure</li>
        </ul>

        <p class="text-gray-700">
            Causes include diabetes, hypertension, infections,
            genetic conditions, obstruction from stones,
            and exposure to nephrotoxic medications.
        </p>
    </div>
</section>
...
<section id="benefits" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>End-stage renal disease requiring dialysis or transplant</li>
...
<section id="risks" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Blood tests including creatinine, urea, and electrolytes</li>
            <li>Urine analysis for protein, blood, and infection</li>
            <li>Imaging such as ultrasound or CT scan</li>
            <li>Kidney biopsy when diagnosis is unclear</li>
            <li>Regular screening for high-risk patients</li>
        </ul>
    </div>
</section>
...
<section id="advantages" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Medications for blood pressure control and infection management</li>
            <li>Immunosuppressive therapy for autoimmune kidney disease</li>
            <li>Hemodialysis and peritoneal dialysis</li>
            <li>Kidney transplant evaluation and surgical coordination</li>
            <li>Lifestyle modification including diet and fluid management</li>
        </ul>
    </div>
</section>
...
<section id="faqs" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <p class="text-gray-700 leading-relaxed mb-6">
            Early detection and consistent management slow disease progression.
            Dialysis and transplantation enable patients to lead active lives.
            With structured care, many individuals achieve long-term stability.
        </p>
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Experienced nephrologists and transplant surgeons</li>
            <li>Advanced dialysis units with strict infection control</li>
            <li>Multidisciplinary support including dietitians and counselors</li>
            <li>Patient education and long-term care programs</li>
        </ul>
    </div>
</section>
