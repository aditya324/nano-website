...
<head>
    ...
    <title>Emergency & Critical Care – Nano Hospitals</title>
    <style>
        .pill-btn {
            padding: 8px 18px;
...
<section class="relative w-full min-h-[520px]">
    <img src="./assets/banners/health-package-banner.png" alt="Emergency and Critical Care"
        ...
        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            ...
            <div class="flex-1 md:pl-10">
                <p class="text-gray-500 text-sm md:text-base leading-relaxed">
                    Emergency & Critical Care is the frontline of Nano Hospitals, providing
                    round-the-clock life-saving interventions for patients in crisis.
                    Rapid response and timely decision-making are critical in emergencies.
                </p>

                <div id="moreContent"
                    class="hidden mt-2 text-gray-500 text-sm md:text-base leading-relaxed">
                    <p>
                        Critical Care extends beyond the emergency room into advanced Intensive
                        Care Units, where patients with life-threatening conditions receive
                        continuous monitoring and specialised treatment.
                    </p>
                    <p class="mt-2">
                        The focus is on stabilisation, organ support, and recovery through
...
<section id="overview" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        <h2 class="text-2xl md:text-3xl font-semibold mb-6">
            Introduction to Emergency & Critical Care
        </h2>
        <p class="text-gray-700 leading-relaxed">
            Emergency & Critical Care manages acute, life-threatening medical situations
            requiring immediate intervention. Rapid assessment and advanced treatment
            significantly improve survival and outcomes.
        </p>
    </div>
</section>
...
<section id="workflow" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Heart attacks and cardiac arrest</li>
            <li>Stroke and neurological emergencies</li>
            <li>Trauma from accidents and injuries</li>
            <li>Respiratory failure including asthma and pneumonia</li>
...
<section id="delivery" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700 mb-4">
            <li>Severe chest pain or breathlessness</li>
        ...
        <p class="text-gray-700">
            Causes include lifestyle diseases, accidents, infections,
            and sudden worsening of chronic medical conditions.
        </p>
    </div>
</section>
...
<section id="risks" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Rapid clinical evaluation</li>
            <li>ECG and cardiac enzymes for heart attacks</li>
            <li>CT/MRI for stroke and trauma</li>
            <li>Blood tests for infections and sepsis</li>
            <li>Preventive health check-ups and safety measures</li>
        </ul>
    </div>
</section>
...
<section id="advantages" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Advanced Life Support including CPR and ventilator care</li>
            <li>Emergency surgeries for trauma and stroke</li>
            <li>ICU care with advanced monitoring and dialysis support</li>
            <li>Medications such as clot-busters and antibiotics</li>
            <li>Multidisciplinary care by intensivists and specialists</li>
        </ul>
    </div>
</section>
...
<section id="faqs" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <p class="text-gray-700 leading-relaxed mb-6">
            Early intervention saves lives and reduces complications.
            ICU patients may require prolonged recovery and rehabilitation.
            Long-term follow-up ensures stability and prevents recurrence.
        </p>
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <li>Advanced ICU facilities with ventilators and dialysis</li>
            <li>Experienced critical care specialists</li>
            <li>Integrated trauma, cardiac, and neurological care</li>
            <li>Compassionate family support during emergencies</li>
        </ul>
    </div>
</section>
