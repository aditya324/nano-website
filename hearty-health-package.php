...
<body>
             ...
             gap-10 lg:gap-14">
                ...
                <div class="w-full lg:w-1/2">
                    <img
                        ...
                        class="w-full h-[493px] rounded-2xl object-cover shadow-2xl" />
                </div>

                <!-- RIGHT CONTENT -->
                <div class="w-full lg:w-1/2">
                    <h3 class="text-2xl font-semibold text-gray-800 mb-2">
                        hearty Health Package
                    </h3>
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="flex-1 md:pl-10">
                    <p class="text-gray-500 text-sm md:text-base leading-relaxed">
                        The Healthy Heart Package focuses on early detection and prevention of heart-related conditions through advanced cardiac tests, vascular Doppler studies, and metabolic screening. It evaluates cholesterol, diabetes, thyroid, and kidney health while supporting a complete cardiovascular risk assessment for individuals with lifestyle or hereditary cardiac risks.
                        <!-- Read More -->
                        <a
                            href="#"
        ...
        <div class="max-w-6xl mx-auto px-6">
         ...
         p-6 md:p-8 w-full">
             ...
             rounded-md text-sm font-semibold">
                        ...
                        <h3 class="text-lg font-semibold text-gray-800 leading-snug">
                            Carotid and Vertebral<br />
                            Doppler Study
                        </h3>
                    </div>

                    <!-- LIST (optional – add parameters if needed) -->
                    <ul class="space-y-2 text-sm text-gray-600 pl-4">
                        <!-- Example (optional):
    <li class="relative pl-3">
      <span class="absolute left-0 top-2 w-1.5 h-1.5 bg-[#FA424A] rounded-full"></span>
    ...
    <li class="relative pl-3">
      <span class="absolute left-0 top-2 w-1.5 h-1.5 bg-[#FA424A] rounded-full"></span>
      Vertebral Artery Flow Assessment
    </li>
    -->
                    </ul>
         ...
         p-6 md:p-8 w-full">
             ...
             rounded-md text-sm font-semibold">
                    ...
                    <!-- LIST (optional – add details if required) -->
                    <ul class="space-y-2 text-sm text-gray-600 pl-4">
                        <!-- Example (optional):
    <li class="relative pl-3">
      <span class="absolute left-0 top-2 w-1.5 h-1.5 bg-[#FA424A] rounded-full"></span>
    ...
    -->
         ...
         p-6 md:p-8 w-full">
             ...
             rounded-md text-sm font-semibold">
                    ...
                    <!-- LIST (add parameters if needed later) -->
                    <ul class="space-y-2 text-sm text-gray-600 pl-4">
                        <!-- Example:
    <li class="relative pl-3">
      <span class="absolute left-0 top-2 w-1.5 h-1.5 bg-[#FA424A] rounded-full"></span>
