...
<head>
    ...
    <title>Obesity – Nano Hospitals</title>
    <style>
        .pill-btn {
            padding: 8px 18px;
...
<section class="relative w-full min-h-[520px]">
    <img src="./assets/banners/health-package-banner.png" alt="Obesity"
        ...
        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            ...
            <div class="flex-1 md:pl-10">
                <p class="text-gray-500 text-sm md:text-base leading-relaxed">
                    Obesity is a chronic lifestyle-related condition characterised by excessive
                    accumulation of body fat that negatively impacts health. It is commonly assessed
                ...
                <div id="moreContent"
                    ...
                    <p>
                        Obesity increases the risk of multiple chronic diseases and can significantly
                        reduce quality of life if not addressed early.
                    </p>
                    <p class="mt-2">
                        At Nano Hospitals, obesity care focuses on sustainable weight reduction through
                        medical guidance, lifestyle change, and long-term monitoring.
                    </p>
                </div>
...
<section id="overview" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <p class="text-gray-700 leading-relaxed">
            ...
            leading to excessive fat storage and increased health risks.
        </p>
    </div>
</section>
...
<section id="delivery" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>High-calorie and unhealthy diet</li>
            <li>Sedentary lifestyle</li>
            <li>Genetic predisposition</li>
            <li>Hormonal imbalances (thyroid disorders, PCOS)</li>
        </ul>
    </div>
</section>
...
<section id="risks" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <li>Blood tests (cholesterol, blood sugar)</li>
            <li>Balanced diet and regular exercise</li>
            <li>Routine weight monitoring</li>
        </ul>
    </div>
</section>
...
<section id="advantages" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <li>Weight-loss medications (orlistat, GLP-1 agonists)</li>
            <li>Bariatric surgery for severe obesity</li>
            <li>Long-term follow-up and counselling</li>
        </ul>
    </div>
</section>
...
<section id="faqs" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <p class="text-gray-700 leading-relaxed">
            Weight loss significantly improves overall health, reduces the risk of chronic
            diseases, and enhances quality of life when sustained through long-term lifestyle
            changes.
        </p>
    </div>
</section>
