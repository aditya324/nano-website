        ...
        <div class="container mx-auto px-4 sm:px-6 xl:px-8 pt-10">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-10 relative">
                ...
                <div class="relative flex justify-center xl:block">
                    ...
                    <!-- DOCTOR IMAGE -->
                    <img
                        src="./assets/doctors/Dr  Prashanth S Gorur - Ortho.png"
                        alt="Dr Mohan M R"
                        class="
            w-[220px] sm:w-[260px] xl:w-[400px]
            relative xl:absolute
            xl:-top-4 xl:left-60 xl:-translate-x-1/2
            z-40
          " />
                    ...
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                        <div>
                            ...
                            <p class="text-sm text-gray-600">
                                Specialist in Complex Trauma and Paediatric Orthopaedic
                            </p>
                        </div>
                    </div>
          ...
          ">
                        ...
                        <div class="bg-white rounded-xl px-5 py-4">
                            ...
                            <p class="text-sm text-gray-600 mt-1">
                                Paediatrics, Reconstructive Surgeries, Robotic Surgeries,
