        ...
        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            ...
            <div class="flex-1 md:pl-10">
                <p class="text-gray-500 text-sm md:text-base leading-relaxed">
                    Peptic ulcer disease (PUD) refers to open sores in the lining of the stomach,
                    duodenum, or esophagus. These ulcers develop when the protective mucosal
                    lining is damaged by stomach acid and digestive enzymes.
                </p>

                <div id="moreContent"
                    class="hidden mt-2 text-gray-500 text-sm md:text-base leading-relaxed">
                    <p>
                        Ulcers may remain silent initially but can progress to serious
                        complications such as bleeding or perforation if untreated.
                    </p>
                    <p class="mt-2">
                        At Nano Hospitals, peptic ulcer care focuses on accurate diagnosis,
                        eradication of the underlying cause, and prevention of recurrence.
                    </p>
                </div>
...
<section id="overview" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <p class="text-gray-700 leading-relaxed">
            Peptic ulcers form when the stomach or duodenal lining is eroded by acid.
            Pain typically worsens at night or when the stomach is empty. Early treatment
...
<section id="workflow" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Burning or gnawing stomach pain (worse at night or when hungry)</li>
...
<section id="delivery" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li><em>H. pylori</em> infection – weakens the protective mucosal lining</li>
            <li>Long-term NSAID use – damages stomach lining</li>
            <li>Smoking and alcohol – increase acid production</li>
            <li>Stress – aggravates symptoms</li>
        </ul>
    </div>
</section>
...
<section id="benefits" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Severe bleeding leading to anemia or shock</li>
            <li>Perforation with leakage of stomach contents</li>
...
<section id="risks" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Endoscopy for direct visualization</li>
            <li><em>H. pylori</em> testing (urea breath or stool antigen)</li>
            <li>Barium swallow X-ray</li>
            <li>Avoid unnecessary NSAID use</li>
            <li>Balanced diet and stress management</li>
        </ul>
    </div>
</section>
...
<section id="advantages" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Proton pump inhibitors (PPIs) to reduce acid</li>
            <li>Antibiotics to eradicate <em>H. pylori</em></li>
            <li>Antacids for temporary symptom relief</li>
            <li>Dietary changes and small frequent meals</li>
            <li>Surgery (rare) for bleeding or perforated ulcers</li>
        </ul>
    </div>
</section>
...
<section id="faqs" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <p class="text-gray-700 leading-relaxed">
            Most peptic ulcers heal within weeks of appropriate treatment.
            Long-term outlook is excellent when the underlying causes are
