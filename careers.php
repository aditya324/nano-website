...
<body class="bg-[#f5f5f5] font-sans">
    ...
    <section class="p-10">
        <h3 class="text-[#585858] text-center text-3xl font-semibold pb-5">Be Part of the Nano Family – We’re Hiring</h3>
        <div class="flex justify-center gap-10 flex-wrap">

            <div
                class="w-[355.13px] bg-white rounded-3xl p-3
         shadow-xl border border-dashed border-gray-300
         transition-all duration-300 ease-out
         hover:-translate-y-2 hover:shadow-2xl
         hover:border-red-400 group"> <!-- IMAGE -->
                <div class="rounded-2xl overflow-hidden">
                    <img
                        src="./assets/doctor (2).png"
                        alt="Basic Health Package"
                        class=" h-[258px]  object-cover" />
                </div>

                <!-- CONTENT -->
                <div class="text-center mt-4 px-2 text-[#585858]">
         ...
         hover:border-red-400 group"> <!-- IMAGE -->
                ...
                <div class="text-center mt-4 px-2 text-[#585858]">
                    ...
                    <!-- PRICE -->
                    <div class="flex justify-center items-center font-semibold gap-3 mt-2 text-[#585858]">
                        Our administrative staff keep hospital operations seamless and organized. </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-6 items-center">
                ...
                <div class="space-y-6">
                    <!-- Healthy Start -->
                    <div class="relative rounded-2xl overflow-hidden">
                        <img src="./assets/Frame 722 (1).png" class="w-full h-56 object-cover" />
                        <div class="absolute inset-0 bg-black/25"></div>
                ...
                <div class="space-y-6">
                    <!-- Cancer Free -->
                    <div class="relative rounded-2xl overflow-hidden">
                        <img src="./assets/Frame 714.png" class="w-full h-56 object-cover" />
                        <div class="absolute inset-0 bg-black/25"></div>
