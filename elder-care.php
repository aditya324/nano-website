...
<head>
    ...
    <title>Elder Care – Nano Hospitals</title>
    <style>
        .pill-btn {
            padding: 8px 18px;
...
<section class="relative w-full min-h-[520px]">
    <img src="./assets/banners/health-package-banner.png" alt="Elder Care"
        ...
        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            ...
            <div class="flex-1 md:pl-10">
                <p class="text-gray-500 text-sm md:text-base leading-relaxed">
                    Elder Care at Nano Hospitals is designed to support senior citizens
                    with dignity, comfort, and independence. Geriatric care focuses on
                    addressing medical, emotional, and social needs unique to ageing.
                </p>

                <div id="moreContent"
                    class="hidden mt-2 text-gray-500 text-sm md:text-base leading-relaxed">
                    <p>
                        With advancing age, multiple chronic conditions, mobility
                        challenges, and emotional concerns often coexist.
                    </p>
                    <p class="mt-2">
                        Care is delivered through a holistic, family-centred approach
                        ensuring safety, respect, and quality of life.
                    </p>
                </div>
...
<section id="overview" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <p class="text-gray-700 leading-relaxed">
            Elder Care focuses on comprehensive management of health issues
            affecting senior citizens, with emphasis on independence,
...
<section id="workflow" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Chronic diseases such as diabetes, hypertension, and arthritis</li>
            <li>Dementia and Alzheimer’s disease</li>
            <li>Mobility issues and frailty</li>
            <li>Depression, loneliness, and emotional concerns</li>
            <li>Post-surgical recovery in elderly patients</li>
        </ul>
    </div>
</section>
...
<section id="delivery" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700 mb-4">
            ...
            <li>Weakness and frequent falls</li>
            <li>Chronic pain and stiffness</li>
            <li>Social isolation and depression</li>
        </ul>

        <p class="text-gray-700">
            Causes include ageing-related degeneration, chronic illness,
            nutritional deficiencies, and limited social support.
        </p>
    </div>
</section>
...
<section id="benefits" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Increased hospitalisations</li>
            <li>Permanent disability</li>
            <li>Reduced life expectancy</li>
            <li>Emotional distress and loss of independence</li>
        </ul>
    </div>
</section>
...
<section id="risks" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <li>Blood tests for chronic conditions</li>
            <li>Cognitive testing for dementia</li>
            <li>Mobility and functional evaluations</li>
            <li>Regular health check-ups and fall prevention</li>
        </ul>
    </div>
</section>
...
<section id="advantages" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Medical management of chronic diseases</li>
            <li>Physiotherapy for mobility and fall prevention</li>
            <li>Counseling for emotional wellbeing</li>
            <li>Nutrition care tailored to elderly needs</li>
            <li>Home care support and caregiver assistance</li>
        </ul>
    </div>
</section>
...
<section id="faqs" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <p class="text-gray-700 leading-relaxed mb-6">
            With structured medical care, rehabilitation, and emotional support,
            elderly patients can regain independence and enjoy better quality of life.
            Long-term disease management improves longevity and comfort.
        </p>
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Dedicated geriatric specialists</li>
            <li>Multidisciplinary care teams</li>
            <li>Family-centred care approach</li>
            <li>Integration of hospital and home care services</li>
            <li>Focus on dignity, comfort, and independence</li>
        </ul>
    </div>
</section>
