...
<head>
    ...
    <title>Asthma – Nano Hospitals</title>
    <style>
        .pill-btn {
            padding: 8px 18px;
...
<section class="relative w-full min-h-[520px]">
    <img src="./assets/banners/health-package-banner.png" alt="Asthma"
        ...
        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            ...
            <div class="flex-1 md:pl-10">
                <p class="text-gray-500 text-sm md:text-base leading-relaxed">
                    ...
                    and narrowing of the airways, leading to difficulty in breathing.
                ...
                <div id="moreContent"
                    ...
                    <p>
                        Asthma symptoms are often triggered by allergens, air pollution,
                        respiratory infections, or physical exertion.
                    </p>
                    <p class="mt-2">
                        At Nano Hospitals, asthma care focuses on symptom control,
                        trigger avoidance, and improving long-term lung health.
                    </p>
                </div>
...
<section id="overview" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <p class="text-gray-700 leading-relaxed">
            Asthma causes recurrent episodes of breathing difficulty due to airway
            inflammation and muscle tightening. With appropriate management,
...
<section id="workflow" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <li>Cough, especially at night or early morning</li>
        </ul>
    </div>
</section>
...
<section id="delivery" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Allergens such as dust, pollen, and pet dander</li>
...
<section id="risks" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <li>Avoidance of known triggers</li>
            <li>Use of air purifiers and regular check-ups</li>
        </ul>
    </div>
</section>
...
<section id="advantages" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <li>Oral medications such as leukotriene inhibitors</li>
            <li>Lifestyle modifications and trigger control</li>
        </ul>
    </div>
</section>
...
<section id="faqs" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <p class="text-gray-700 leading-relaxed">
            Although asthma cannot be cured, it can be effectively controlled with
            proper treatment, allowing patients to lead normal and active lives.
        </p>
    </div>
</section>
