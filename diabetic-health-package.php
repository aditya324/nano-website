            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="flex-1 md:pl-10">
                    <p class="text-gray-500 text-sm md:text-base leading-relaxed">
                        The Diabetic Package is a comprehensive health evaluation designed for effective diabetes management. It monitors blood sugar control, long-term glucose levels, and associated metabolic risks. Kidney, liver, thyroid, and lipid profiles help detect diabetes-related complications early. Cardiac screening, imaging, and urine analysis support complete organ health assessment. An essential package for proactive diabetes care and long-term well-being. </p>
                    <a
                        href="#"
