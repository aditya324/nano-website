...
<head>
    ...
    <title>COPD / Chronic Bronchitis – Nano Hospitals</title>
    <style>
        .pill-btn {
            padding: 8px 18px;
...
<section class="relative w-full min-h-[520px]">
    <img src="./assets/banners/health-package-banner.png" alt="COPD and Chronic Bronchitis"
        ...
        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            ...
            <div class="flex-1 md:pl-10">
                <p class="text-gray-500 text-sm md:text-base leading-relaxed">
                    ...
                    that includes chronic bronchitis and emphysema, causing persistent airflow
                    limitation and breathing difficulty.
                </p>

                <div id="moreContent"
                    class="hidden mt-2 text-gray-500 text-sm md:text-base leading-relaxed">
                    <p>
                        COPD is most commonly associated with long-term smoking, but air pollution,
                        occupational exposure, and genetic factors also contribute to its development.
                    </p>
                    <p class="mt-2">
                        At Nano Hospitals, COPD care focuses on symptom control, slowing disease
                        progression, and improving daily functioning and quality of life.
                    </p>
                </div>
...
<section id="overview" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <p class="text-gray-700 leading-relaxed">
            COPD causes long-term breathing problems due to damage and inflammation of the airways
            and lung tissue. Early diagnosis and appropriate treatment can significantly slow
            disease progression.
        </p>
    </div>
</section>
...
<section id="delivery" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Smoking (primary cause)</li>
            <li>Air pollution and biomass fuel exposure</li>
            <li>Occupational dust and chemical exposure</li>
...
<section id="risks" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Spirometry to assess lung function</li>
            <li>Chest X-ray or CT scan</li>
            <li>Blood oxygen level measurement</li>
            <li>Smoking cessation</li>
            <li>Avoidance of pollution and occupational hazards</li>
        </ul>
    </div>
</section>
...
<section id="advantages" class="scroll-mt-32 bg-[#f6f6f6] py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Inhalers (bronchodilators and corticosteroids)</li>
            <li>Oxygen therapy in advanced cases</li>
            <li>Pulmonary rehabilitation programs</li>
            <li>Surgical options such as lung volume reduction or transplant</li>
        </ul>
    </div>
</section>
...
<section id="faqs" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <p class="text-gray-700 leading-relaxed">
            COPD cannot be cured, but with early diagnosis, smoking cessation, and
            appropriate treatment, symptoms can be controlled and quality of life
