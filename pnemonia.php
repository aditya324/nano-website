...
<head>
    ...
    <title>Pneumonia & Lower Respiratory Infections – Nano Hospitals</title>
    <style>
        .pill-btn {
            padding: 8px 18px;
...
<section class="relative w-full min-h-[520px]">
    <img src="./assets/banners/health-package-banner.png" alt="Pneumonia and Respiratory Infections"
        ...
        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            ...
            <div class="flex-1 md:pl-10">
                <p class="text-gray-500 text-sm md:text-base leading-relaxed">
                    ...
                    leading to inflammation of the air sacs and difficulty in breathing.
                </p>

                <div id="moreContent"
                    class="hidden mt-2 text-gray-500 text-sm md:text-base leading-relaxed">
                    <p>
                        It commonly affects children, the elderly, and individuals with weakened
                        immune systems, and can range from mild to life-threatening.
                    </p>
                    <p class="mt-2">
                        At Nano Hospitals, pneumonia care emphasizes early diagnosis, appropriate
                        antimicrobial therapy, and respiratory support for faster recovery.
                    </p>
                </div>
...
<section id="overview" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <p class="text-gray-700 leading-relaxed">
            Pneumonia occurs when infectious agents inflame the lung tissue, filling air sacs
            with fluid or pus and reducing oxygen exchange. Prompt treatment is critical
...
<section id="delivery" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            <li>Bacterial infections (e.g., Streptococcus pneumoniae)</li>
            <li>Viral infections such as influenza and COVID-19</li>
            <li>Fungal infections (rare)</li>
        </ul>
    </div>
</section>
...
<section id="risks" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <li>Vaccinations (influenza and pneumococcal)</li>
            <li>Good hygiene and smoking avoidance</li>
        </ul>
    </div>
</section>
...
<section id="faqs" class="scroll-mt-32 bg-white py-14">
    <div class="container mx-auto px-4">
        ...
        <p class="text-gray-700 leading-relaxed">
            Most cases of pneumonia resolve completely with timely treatment.
            Severe infections may require intensive care, but early medical
