            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="flex-1 md:pl-10">
                    <p class="text-gray-500 text-sm md:text-base leading-relaxed">
                        The Nano Hospitals Master Health Package offers a comprehensive evaluation of your overall health. It includes detailed blood tests, cardiac screening, and advanced imaging for early detection of health risks. Key organ functions such as heart, liver, kidneys, thyroid, and metabolism are thoroughly assessed. Ultrasound, ECG, and chest X-ray provide a complete internal health overview. A preventive health package designed to help you take control of your health with confidence at Nano Hospitals.
                        <!-- Read More -->
                        <a
                            href="#"
