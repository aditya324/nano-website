            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="flex-1 md:pl-10">
                    <p class="text-gray-500 text-sm md:text-base leading-relaxed">
                        The Senior Citizen Health Package is designed to address age-related health concerns proactively. It includes comprehensive blood tests, cardiac evaluation, and vital organ function screening. Diabetes, cholesterol, thyroid, and vitamin levels are carefully monitored. Pulmonary tests and imaging support respiratory and internal health assessment. An ideal package for maintaining health, independence, and peace of mind in later years. </p>
